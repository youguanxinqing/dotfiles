...
PATH="$TEST_BIN:$TEST_HOME/.goup/current/bin:$TEST_SYSTEM_PATH" HOME="$TEST_HOME" CARGO_INSTALL_ROOT="$TEST_HOME/.local" \
  GOUP_TEST_TEMPLATE="$TEST_ROOT/goup-template" \
  "$ROOT/modules/goup/install.sh" install
[[ -x "$TEST_HOME/.local/bin/goup" ]]
PATH="$TEST_HOME/.local/bin:$TEST_BIN:$TEST_HOME/.goup/current/bin:$TEST_SYSTEM_PATH" HOME="$TEST_HOME" CARGO_INSTALL_ROOT="$TEST_HOME/.local" \
  "$ROOT/modules/goup/install.sh" check
PATH="$TEST_BIN:$TEST_SYSTEM_PATH" HOME="$TEST_HOME" CARGO_INSTALL_ROOT="$TEST_HOME/.local" GOUP_TEST_TEMPLATE="$TEST_ROOT/goup-template" \
